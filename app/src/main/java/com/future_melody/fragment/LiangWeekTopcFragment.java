 ...
 * Notes:日榜 周榜 月榜
 */
public class LiangWeekTopcFragment extends BaseFragment implements AdapterView.OnItemClickListener {
...
//        }
    ...
    public void onResume() {
        ...
        UmengUtils.onResumeToFragment("LiangWeekTopcFragment");
    }

    @Override
    public void onPause() {
        super.onPause();
        UmengUtils.onPauseToFragment("LiangWeekTopcFragment");
    }
