 ...
 * Notes:月榜
 */
public class LiangMonthTopcFragment extends BaseFragment implements AdapterView.OnItemClickListener {
...
//        }
    ...
    public void onResume() {
        ...
        UmengUtils.onResumeToFragment("LiangMonthTopcFragment");
    }

    @Override
    public void onPause() {
        super.onPause();
        UmengUtils.onPauseToFragment("LiangMonthTopcFragment");
    }

    private void getList(int category) {
        addSubscribe(apis.musicleader(new GetMusicLeaderReqest(userId(), 1, 50, category))
                ...
                .subscribeWith(new HttpSubscriber<List<GetMusicLeaderRespone>>(new HttpSubscriber.ErrorListener() {
                    ...
                    public void onNext(List<GetMusicLeaderRespone> getMusicLeaderRespones) {
                        ...
                        adapter = new TopDetailsMusicAdapter(mActivity, list, songInfos);
