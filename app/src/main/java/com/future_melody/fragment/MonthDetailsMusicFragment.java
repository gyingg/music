 ...
 * Notes:日榜 周榜 月榜
 */
public class MonthDetailsMusicFragment extends BaseFragment implements AdapterView.OnItemClickListener {
    ...
    public void onResume() {
        ...
        UmengUtils.onResumeToFragment("MonthDetailsMusicFragment");
    }

    @Override
    public void onPause() {
        super.onPause();
        UmengUtils.onPauseToFragment("MonthDetailsMusicFragment");
    }
