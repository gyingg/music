 ...
 * Notes:日榜 周榜 月榜
 */
public class WeekTopDetailsMusicFragment extends BaseFragment implements AdapterView.OnItemClickListener {
...
//        getList(1);
    ...
    public void onResume() {
        ...
        UmengUtils.onResumeToFragment("WeekTopDetailsMusicFragment");
    }
        ...
        addSubscribe(apis.xingTop(new XingTopMusicRequest(category, 1, 100, userId()))
                ...
                .subscribeWith(new HttpSubscriber<List<GetMusicLeaderRespone>>(new HttpSubscriber.ErrorListener() {
                    ...
                    public void onNext(List<GetMusicLeaderRespone> getMusicLeaderRespones) {
                        songInfos.clear();
                        top_music_listView.removeHeaderView(headView);
    ...
    public void onPause() {
        super.onPause();
        UmengUtils.onPauseToFragment("WeekTopDetailsMusicFragment");
    }
}
