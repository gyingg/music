 ...
 * Notes:
 */
public class TopDetailsMusicAdapter extends BaseAdapter {
    private Context mContext;
    private List<GetMusicLeaderRespone> lists;
    private ArrayList<SongInfo> songInfos;

    public TopDetailsMusicAdapter(Context mContext, List<GetMusicLeaderRespone> lists, ArrayList<SongInfo> songInfos) {
...
//        }
        ...
        holder.star_music_sing.setText("来自" + model.nickname + "的推荐");
