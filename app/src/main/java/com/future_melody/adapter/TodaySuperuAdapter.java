...
public class TodaySuperuAdapter extends  RecyclerView.Adapter<TodaySuperuAdapter.ViewHolder> {
    private Context context;
    private List<WeekSuperuRespone> list;

    public TodaySuperuAdapter(Context context, List<WeekSuperuRespone> list) {
        this.context = context;
        this.list = list;
    }

    @Override
    public TodaySuperuAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.fragment_weeksuperu, null);
        TodaySuperuAdapter.ViewHolder viewHolder=new TodaySuperuAdapter.ViewHolder(view);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(TodaySuperuAdapter.ViewHolder holder, int position) {
