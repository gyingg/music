...
public class CardViewPager extends ViewPager {
     ...
     */
    public <T extends Parcelable> void bind(FragmentManager fm, CardHandler<T> handler, List<T> data) {
    ...
    @NonNull
    private <T extends Parcelable> List<CardItem> getCardItems(CardHandler<T> handler, List<T> data, boolean isLoop) {
