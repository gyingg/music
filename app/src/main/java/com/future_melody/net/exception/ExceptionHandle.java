package com.future_melody.net.exception;
...
//    private static final int GATEWAY_TIMEOUT = 504;
    ...
    interface ERROR {
        ...
        String UNKNOWN = "1000";//未知错误
        String PARSE_ERROR = "1001";//解析错误
        String NETWORK_ERROR = "1002";//网络错误
        String HTTP_ERROR = "1003";//协议出错
        String SSL_ERROR = "1004";//证书出错
        String TIMEOUT_ERROR = "1005";//连接超时
